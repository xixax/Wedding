...
/**
 * Seen at https://zhuinden.medium.com/simple-one-liner-viewbinding-in-fragments-and-activities-with-kotlin-961430c6c07c
 */
class FragmentViewBindingDelegate<T : ViewBinding>(
    ...
    private lateinit var viewLifecycle: Lifecycle
    ...
    override fun getValue(thisRef: Fragment, property: KProperty<*>): T {
        ...
        if (!::viewLifecycle.isInitialized || viewLifecycle != lifecycle) {
    ...
    private fun observeViewDestroy() {
