...
import com.e.wedding.databinding.RecyclerInviteItemBinding
...
class InviteAdapter(private val context: Context, private val images: List<Image>) : RecyclerView.Adapter<InviteAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: RecyclerInviteItemBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): InviteAdapter.ViewHolder {
        return ViewHolder(RecyclerInviteItemBinding.inflate(LayoutInflater.from(context), parent, false))
    }
