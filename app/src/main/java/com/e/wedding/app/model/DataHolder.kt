...
object DataHolder {
    ...
    const val APP_MAIN_CONFIG_URL: String = "https://drive.google.com/file/d/1T7V41tbAWiRbgS6EDlXRgAc7Gd6h5IBn/view?usp=sharing"
    private lateinit var mAppConfiguration: AppConfiguration
